...
public class AttachmentProxyServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    String contentType = GlassClient.getAttachmentContentType(credential, timelineItemId, attachmentId);

    // Get the attachment bytes
    InputStream attachmentInputStream = GlassClient.getAttachmentInputStream(credential, timelineItemId, attachmentId);
